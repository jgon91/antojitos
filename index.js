...
var appId = process.env.APP_ID || 'sbpKMx76CTPTec3IfRtC';
var masterKey = process.env.MASTER_KEY || 's8nwFpRCz6t7BzYxkfJf';
var restApiKey = 'bqEiwzR141ePdMW0eQE6';
var appName = 'nearme';

// Mailgun configuration
var apiKey = process.env.MAILGUN_API_KEY || 'key-5e05c37462e4a0c3560dd7ee155dfb99';
var domain = process.env.MAILGUN_DOMAIN || 'sandbox31d2828f692b42259a19024858d96622.mailgun.org';
var fromAddress = process.env.MAILGUN_FROM_ADDRESS || 'Jessica <jessica@gmail.com>';

// AWS S3 configuration
var accessKeyId = process.env.AWS_ACCESS_KEY_ID || 'AKIAIKFIEEIUGCDCMKUA';
var secretAccessKey = process.env.AWS_SECRET_ACCESS_KEY || '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';
var bucketName = process.env.BUCKET_NAME || 'antojitos';
...
var api = new ParseServer({
  databaseURI: databaseUri || 'mongodb://<dbuser>:<dbpassword>@ds125262.mlab.com:25262/ant-db',
